...
function Conversion() {
	...
	GetEl('#output_area').value = HindiUnicodeToSaral(input_str);
}



function HindiUnicodeToSaral(str) {

	let lan1 = [...Master_obj.map(function (item) {
		return item.lan1
	})];
	let lan2 = [...Master_obj.map(function (item) {
		return item.lan2
	})];
